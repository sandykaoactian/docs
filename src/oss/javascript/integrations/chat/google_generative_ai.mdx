...
This will help you getting started with `ChatGoogleGenerativeAI` [chat models](/oss/langchain/models). For detailed documentation of all `ChatGoogleGenerativeAI` features and configurations head to the [API reference](https://reference.langchain.com/javascript/langchain-google-genai/ChatGoogleGenerativeAI).
...
<Tip>
You can also access Google's `gemini` family of models via the LangChain VertexAI and VertexAI-web integrations. See the [Vertex AI integration docs](/oss/integrations/chat/google_vertex_ai).
</Tip>
