...
This guide will help you getting started with `ChatOpenAI` [chat models](/oss/langchain/models). For detailed documentation of all `ChatOpenAI` features and configurations head to the [API reference](https://reference.langchain.com/javascript/langchain-openai/ChatOpenAI).
