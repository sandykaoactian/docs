...
This guide will help you getting started with `ChatXAI` [chat models](/oss/langchain/models). For detailed documentation of all `ChatXAI` features and configurations head to the [API reference](https://reference.langchain.com/javascript/langchain-xai/ChatXAI).
