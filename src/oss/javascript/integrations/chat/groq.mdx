...
This will help you getting started with `ChatGroq` [chat models](/oss/langchain/models). For detailed documentation of all `ChatGroq` features and configurations head to the [API reference](https://reference.langchain.com/javascript/langchain-groq/ChatGroq).
