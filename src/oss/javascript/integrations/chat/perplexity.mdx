...
This guide will help you getting started with `ChatPerplexity` [chat models](/oss/langchain/models). For detailed documentation of all `ChatPerplexity` features and configurations head to the [API reference](https://reference.langchain.com/javascript/langchain-community/chat_models/perplexity/ChatPerplexity).
