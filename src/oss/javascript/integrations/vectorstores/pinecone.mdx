...
This guide provides a quick overview for getting started with `PineconeStore` [vector stores](/oss/integrations/vectorstores). For detailed documentation of all `PineconeStore` features and configurations head to the [API reference](https://reference.langchain.com/javascript/langchain-pinecone/PineconeStore).
