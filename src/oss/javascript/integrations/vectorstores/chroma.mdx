...
This guide provides a quick overview for getting started with `Chroma` [vector stores](/oss/integrations/vectorstores). For detailed documentation of all `Chroma` features and configurations head to the [API reference](https://reference.langchain.com/javascript/langchain-community/vectorstores/chroma/Chroma).
